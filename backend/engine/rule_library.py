    ...
    def get_rules_for_datatype(dtype: str):
        ...
        if dtype in ["string", "varchar", "text", "char"]:
            return common_rules + [
                ...
                {"name": "Exact Values", "code": "exact_values", "input_needed": True, "desc": "Must exactly match one allowed value (comma-separated list supported)"},
        ...
        # --- 3. INTEGER / FLOAT / NUMERIC RULES ---
            ...
            return common_rules + [
                ...
                {"name": "Equals", "code": "equals", "input_needed": True, "desc": "Value must exactly equal X"},
                {"name": "Not Equals", "code": "not_equals", "input_needed": True, "desc": "Value must not equal X"},
