      ...
      headerContent={
        <div className="flex items-start gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-xs text-muted-foreground">Validation rules, data quality results, and smart charts (read-only)</p>
      ...
      {loading ? (
        ...
        <div className="grid gap-4 lg:grid-cols-12 lg:items-start">
          ...
          <div className="lg:col-span-5 xl:col-span-4 lg:sticky lg:top-0">
            <DatasetCatalogChartInsights datasetId={datasetId} enabled={hasTableData} audience="business" />
          </div>
        </div>
      )}
    </AppModal>
