    ...
    <div className="min-h-screen bg-[#FBFBFB] flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white border border-gray-200 p-6">
        ...
        <form className="space-y-4" onSubmit={onSubmit}>
          <input className="w-full border border-gray-300 px-3 py-2" placeholder="Username or company email" type="text" required value={loginId} onChange={(e) => setLoginId(e.target.value)} />
          <input className="w-full border border-gray-300 px-3 py-2" placeholder="Password" type="password" required value={password} onChange={(e) => setPassword(e.target.value)} />
